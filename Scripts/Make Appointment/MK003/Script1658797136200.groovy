...
//
//WebUI.doubleClick(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/input_Demo account_form-control'))
//
...
//
//WebUI.doubleClick(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/input_Demo account_form-control_1'))
//
//WebUI.click(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/input_Demo account_form-control_1'))
//
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/select_Tokyo CURA Healthcare Center        _5b4107'), 
